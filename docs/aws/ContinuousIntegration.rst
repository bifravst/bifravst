...
.. note::
    ...
    See the `GitHub project page of the Asset Tracker for AWS Example <https://github.com/bifravst/aws/>`_ , for an implementation of the process outlined in this section.
