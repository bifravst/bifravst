...
.. epigraph::
  ...
  *Bifravst* enables the developers to set up a real world IoT solution using
...
*Bifravst* is licensed under the `3-clause BSD license <./LICENSE>`_ (software)
and the
...
`TypeScript <https://www.typescriptlang.org/>`_ (a typed superset of JavaScript).
JavaScript is the most popular language according to the
`2019 Stack Overflow survey <https://insights.stackoverflow.com/survey/2019#technology>`_.
...
`create-react-app <https://github.com/facebook/create-react-app>`_ and it provides
